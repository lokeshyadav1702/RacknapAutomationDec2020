...
public class PurchaseDedicatedServerCredit extends base {
	String Password = "Password12";
	String TopUpAmount = "100000.00";
	String Amount = "$ 143.96";
	String HostName;
	String ServiceAmount = "$ 283.20";
	String Tenure = "";
	...
	public void initialize() throws IOException, InterruptedException {
		...
		lp.getUsername().sendKeys("singh63");
	...
	public void purchaseServerrWithCredit() throws InterruptedException, AWTException {
