...
public class PurchaseBundleOnline extends base {
	...
	public void purchaseBundleOnline(String email,String password,String ConfirmPassword,String FirstName,String LastName,String CompanyName,String Address1,String City,String Currency,String MobileNumber,String Zipcode,String PaypalEmail,String PaypalPassword) throws AWTException, InterruptedException {
		...
		waitForElementToVisible(By.xpath("//input[@placeholder='Enter domain name']"));
		domainName= randomDomainName();
		
		pp.getEmailDomainNameBundle().sendKeys(domainName);
		pp.getBundleEmailSelectButton().click();
		waitForElementToVisible(By.xpath("//span[contains(text(),'Entered domain name is available.')]"));
