...
public class PurchaseDomainOnline extends base {

	String domainName;
	String Domain;
	public static String username;
	String Amount="$ 118.00";
	String expEmailLog="Qa8 - Successful Registration of Domain";
	@BeforeTest
	...
	public void purchaseDomainOrder(String email,String password,String ConfirmPassword,String FirstName,String LastName,String CompanyName,String Address1,String City,String Currency,String MobileNumber,String Zipcode,String PaypalEmail,String PaypalPassword) throws AWTException, InterruptedException {
		...
		try {
		   ...
		   // waitForElementToVisible(By.xpath("//span[text()='CREDIT UNION 1']"));
...
//	    boolean ActualHostname=	HostONUI.contains(DomainName);
...
//	}
   ...
   public void verifyEmailLogs() throws InterruptedException {
      ...
      sp.goToMySupport().click();
		...
		Thread.sleep(3000);
      boolean flag = false;
		if (sp.getEmailSubjectDomain().getText().contains(expEmailLog)) {
			flag = true;
